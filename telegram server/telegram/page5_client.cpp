...
void page5_client::discardSocket()
{
    socket->deleteLater();
    socket=nullptr;
...
void page5_client::on_pushButton_sendMessage_clicked()
{
    if(socket)
    {
        if(socket->isOpen())
...
void page5_client::on_pushButton_sendAttachment_clicked()
{
    if(socket)
    {
        if(socket->isOpen())
...
void page5_client::displayMessage(const QString& str)
{
