...
public:
    ...
    void setupUi(QMainWindow *page4_home)
    {
        ...
        groupBox_chatbox->setGeometry(QRect(360, 0, 421, 541));
        ...
        lineEdit_message->setGeometry(QRect(10, 460, 331, 81));
        ...
        pushButton_sendMessage->setGeometry(QRect(340, 500, 81, 41));
        ...
        pushButton_sendAttachment->setGeometry(QRect(340, 460, 81, 41));
    ...
    void retranslateUi(QMainWindow *page4_home)
    {
        ...
        groupBox_chatbox->setTitle(QString());
