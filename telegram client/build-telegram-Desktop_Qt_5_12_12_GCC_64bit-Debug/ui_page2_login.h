...
public:
    ...
    void setupUi(QMainWindow *page2_login)
    {
        ...
        Verification_Password_lineEdit->setGeometry(QRect(170, 170, 351, 31));
        ...
        showhide_pushButton->setGeometry(QRect(480, 110, 40, 31));
        symbol_label = new QLabel(groupBox);
        symbol_label->setObjectName(QString::fromUtf8("symbol_label"));
        symbol_label->setGeometry(QRect(180, 145, 121, 21));
        ...
        verificationpassword_label->raise();
